...
import { IEfunc, IEclss, IEjson } from './IE.mjs'; // 02 // desestruturação é importar somente o que lhe interessa. ex: arrays, classes, etc (OBS: não é obrigatório importar todas as funções)
